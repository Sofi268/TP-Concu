...
public class Main {
    ...
    public static void main(String[] args) {
        Date hora0 = new Date();
        tiempo = 100/20; //seteo del tiempo.
        ...
        Date hora4 = new Date();
        int t4 = ((hora4.getMinutes()-hora0.getMinutes())*60)+(hora4.getSeconds()-hora0.getSeconds());
        System.out.printf("\n tiempo total: %d -  con %d procesadores" , (t4), numProc);
    }
}
